...
export function Hit({ hit, insights, view }) {
  return (
    ...
    >
      <a href={hit.url} className="uni-Hit-inner" title={hit._rankingInfo}>
        <div className="uni-Hit-image">
          <img src={hit.image} alt={hit.name_eng} loading="lazy" title={'Categories: ' + hit.categories_eng} />
        </div>

        <div className="uni-Hit-Body">
          <header className="uni-Hit-header">
            {/* <h2 className="uni-Hit-category">{hit.categories_eng[0]}</h2> */}

            <h1 className="uni-Hit-title">
              <Highlight attribute="name_eng" tagName="mark" hit={hit} />
            </h1>
          </header>
